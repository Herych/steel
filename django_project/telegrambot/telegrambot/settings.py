...
load_dotenv()
#sys.path.append('/home/taras/Python/STEEL')
...
#SECRET_KEY = 'django-insecure-s@u#zg*-mu+mx$=x&)kr8_m(emx&hu0o79sq+rdqd=$*%y#00x'
SECRET_KEY = os.getenv('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG')

ALLOWED_HOSTS = ['54.204.172.65', 'django']

CSRF_TRUSTED_ORIGINS = ['http://54.204.172.65']
